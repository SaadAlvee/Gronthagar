<?php
    ...
    if(isset($_POST['submit_BB']))
    {
        ...
        $bbsql = "INSERT INTO issued_books (Book_Id, Email, Issue_Date) VALUES ('$bookID1', '$email', '$issuedate')";
        $ggsql = "select *from books where Book_Id = '$bookID1'";
        $issQuery = mysqli_query($db, $bbsql);
        $result = mysqli_query($db, $ggsql);
    ...
    if(isset($_POST['submit_RL']))
    {
        ...
        $ggsql = "select *from books where Book_Id = '$bookID2'";
    ...
    $sql = "SELECT Book_Id, Title, Author,
            Edition, Publisher, Available, Price FROM books";
    ...
    <div class="header">
        ...
        <div class="borrow_read">
            <div style="padding-left: 40px; padding-top: 30px;">
                <h4 style="font-size: 30px;">To  Buy  A  Book:</h4> <br>

                <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                    <input type="number" name="BB-Field" style="width: 33%;" placeholder="Enter the Book ID..." required>

                    <button type="submit" name="submit_BB">Add to Cart</button>
                </form>
